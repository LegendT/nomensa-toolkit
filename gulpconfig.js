module.exports = {
  ...
  patternLab: {
    ...
    scssToJson: [{
      src: 'source/_patterns/00-base/colors/_color-vars.scss',
      dest: 'source/_patterns/00-base/colors/colors.json',
      lineStartsWith: '$c-',
      allowVarValues: false,
    },
    {
      src: 'source/_patterns/00-base/typography/fonts/_fonts.scss',
      dest: 'source/_patterns/00-base/typography/fonts/font-sizes.json',
      lineStartsWith: '$fs--',
      allowVarValues: false,
    },
    {
      src: 'source/_patterns/00-base/typography/fonts/_fonts.scss',
      dest: 'source/_patterns/00-base/typography/fonts/font-families.json',
      lineStartsWith: '$ff--',
      allowVarValues: false,
    },
    {
    ...
    {
      src: 'source/_patterns/00-base/animations/transitions/_transitions.scss',
      dest: 'source/_patterns/00-base/animations/transitions/transitions.json',
